...
//$.get('/product/getProducts', (data)=>{
    ...
    function addProduct(x) {
        ...
        $('.price:eq('+ x +') span').html(data[x].price);
        $('.img-prod:eq('+ x +') img').attr('src', data[x].image);
        $('.product-names:eq('+ x + ')').html(data[x].name);
        $('.product-id:eq('+ x + ')').html(data[x].id);
    }
    ...
    $('.next-page').click(function() {
        ...
        $('.col-6.col-lg-3.ftco-animate').hide();
        ...
        for(var i=min; i<max; i++) {
            $('.col-6.col-lg-3.ftco-animate:eq('+i+')').show();
            $('.col-6.col-lg-3.ftco-animate:eq('+i+')').addClass('fadeInUp ftco-animated');
        }
    });
    ...
    for(var i=numOnOne; i<data.length; i++) {
        $('.col-6.col-lg-3.ftco-animate:eq('+i+')').hide();
    }
